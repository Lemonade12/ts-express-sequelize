...
router.patch("/comment/:id", authMiddleware.auth, postController.updateCommentController); // 댓글수정 및 삭제
router.get("/alarm/:id", postController.readAlarmController); //댓글알림 읽기
